...
**Read:** `instructions.md` → `analyst_instructions.md` → `docs/reference/IDE_AGENT_MISTAKES.md` → `skills/data_injection_planning.md` (before any sector injection plan) → `skills/sizing-audit.md` (Track A sizing factors, not TAM) → other `skills/`
