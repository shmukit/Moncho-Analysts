# Toys harvest — WHAT NOT TO DO

**Locked:** 2026-09-07 (HITL)  
**Applies to:** every product (and org) JSON under `Shudipta/products/Toys/` (same spirit for other retail consumer-product sectors).
...
Process, fetch failures, and scoring caveats belong in **`toys_products_review.md`** (or equivalent review log), not in fields customers may read.
...
See also: `docs/reference/IDE_AGENT_MISTAKES.md` (**P-16**) and `Shudipta/FIs/WHAT_NOT_TO_DO.md` (same customer-facing rule for financial services).
